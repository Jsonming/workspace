    ...
    var n = i("translation:widget/common/cookie")
        ...
        init: function () {
            if (!/baiduinput/gi.test(window.navigator.userAgent)) {
                var i = n.getCookie(a);
                if (i)
                    return void n.setCookie(a, "1", {
                        expires: 5184e6
                    });
                _hmt.push(["_trackEvent", "首页", "首页app导流浮层展现量"]),
                    o.removeClass("app-guide-hide"),
                    n.setCookie(a, "1", {
                        expires: 5184e6
                    }),
                    this.bindEvent()
    ...
    var i = (t("translation:widget/common/environment"),
        {
            ...
            isOverFlag: !1,
            isover: function (t) {
                var e, i = $(t.target), s = i.offset(), o = s.left, r = s.top,
                    n = t.text || i.attr("data-hover-tip-text"), a = $("#hover-tips"),
                    l = i.attr("data-hover-tip-offset"), v = 0, h = 14;
...
;define("translation:widget/translate/details/dictionary/simplemeans", function (t, e) {
    ...
    var n = t("translation:widget/common/third_party/template")
        ...
        , o = t("translation:widget/translate/output/mouseover")
        , i = t("translation:widget/common/environment");
    n.helper("uriComponentTrimAndEncode", function (t) {
        return encodeURIComponent($.trim(t))
    });
    var r, s, u, c = !0, p = 8, d = $("#left-result-container"), l = {
        buildSimpleMeans: function (t) {
            var e = t.data
                , a = (t.to,
                t.baikeImgUrl)
                , o = 2 === parseInt(i.get("firstModuleId"), 10);
            d.append(n("tplDictionary", {
                isFirstCard: o
            }));
            var r, s = {};
            s.tplData = e;
            var u = $(".select-from-language .language-selected").attr("data-lang")
                , c = $(".select-to-language .language-selected").attr("data-lang")
                , p = !1;
            if (("en" === u && "th" === c || "th" === u && "en" === c) && (s.tplData.show_th_detail = !0),
                s.tplData.show_sound = !1,
            ("en" === u || "zh" === u) && (s.tplData.show_sound = !0),
                e.tags) {
                var l = [];
                e.tags.core && e.tags.core.length > 0 && "" !== e.tags.core[0] && (l = l.concat(e.tags.core)),
                e.tags.other && e.tags.other.length > 0 && "" !== e.tags.other[0] && (l = l.concat(e.tags.other)),
                l.length > 0 && (l = l.slice(0, 6),
                    s.tplData.coreTags = l)
            }
            if (e.exchange)
                for (var h in e.exchange)
                    e.exchange[h] && (p = !0);
            s.tplData.showExchange = p,
            "zh" === u && "en" === c && (s.tplData.isZh2En = !0,
                _hmt.push(["_trackEvent", "首页", "Web中英词典释义卡片展现次数"])),
                s.tplData.symbols ? (s.tplData.baikeImgUrl = a,
                    s.tplData.isFirstCard = o,
                    r = n("tplSimplemeans", s),
                a && _hmt.push(["_trackEvent", "首页", "64_首页页面_Web词典释义卡片_图片展现次数"]),
                e.memory_skill && _hmt.push(["_trackEvent", "首页", "73_首页页面_Web词典释义卡片_记忆技巧展现次数"]),
                e.derivative && _hmt.push(["_trackEvent", "首页", "80_首页页面_Web词典释义卡片_派生词展现次数"])) : s.tplData.content && (r = n("tplOtherSimplemeans", s)),
                d.find(".dictionary-wrap").html(r),
        ...
        repeatSound: function (t) {
            ...
            if (n.hasClass("op-repeat-running"))
                ...
                "IE" === BTPM.stage) {
                    var i = n.siblings("b").text();
                    if (i && i.length > 0) {
                        i = i.match(/\[(.*)\]/)[1];
                        var d = e.getRepeatDuration(i);
                        r = setInterval(function () {
                            return 1 > p ? void e.shutdownRepeat() : (BTPM.setUrl(u),
                                void p--)
                        }, d)
                    }
                } else
                    c = !0,
                        $(BTPM).off("ended.repeating").on("ended.repeating", function () {
                            return c ? 1 > p ? void e.shutdownRepeat() : void (s = setTimeout(function () {
                                BTPM.setUrl(u),
                                    p--
                            }, 1200)) : void 0
                        });
        ...
        shutdownRepeat: function (t) {
            ...
            t && t.nopause || BTPM.doPause(),
                "IE" === BTPM.stage ? clearInterval(r) : (clearTimeout(s),
                    c = !1,
        ...
        isoverSound: function (t) {
            if ("hover" === i.get("soundTriggerMode")) {
                var e = this;
...
;define("translation:widget/translate/output/adcards", function (a, t) {
    "use strict";
    var e, r = (a("translation:widget/common/environment"),
        a("translation:widget/common/third_party/template")), n = a("translation:widget/common/cookie"), p = {
        bindEvents: function () {
            $(".translate-wrap").on("click", ".trans-ad-app-control", function () {
                ...
                $("#sideAdData").length > 0 ? (e = "sideAd",
                    $(".translate-wrap").on("click", ".showad-close-btn", function (a) {
        ...
        showAppQr: function (a) {
            if ($(".app-guide").length > 0 && !$(".app-guide").hasClass("app-guide-hide"))
                return void $(".trans-ad-app-wrap").hide();
            if ("appAd" === e) {
                ...
                if ($(".trans-side-ad-wrap").length > 0 && "block" === $(".trans-side-ad-wrap").css("display"))
                    return;
...
;define("translation:widget/translate/details/sample/sample", function (t, e) {
    ...
    var a, n, l, i, s = t("translation:widget/common/third_party/template"),
        ...
        g = $("#left-result-container"), d = ["《柯林斯高阶英汉双解学习词典》", "《汉英大词典》", "百度翻译例句库"], p = void 0, c = {
    ...
    function s(a, t, s, j, N) {
        ...
        !function () {
            if (!a.dict_result || "en" !== s && "zh" !== s && "jp" !== s && "th" !== s)
                ...
                N || (O = a.dict_result,
                    C = a.dict_result.baike_img_url,
                    I = JSON.stringify(a.dict_result));
            else if (a.dict_result.simple_means && !N && (O = a.dict_result.simple_means,
                C = a.dict_result.baike_img_url,
            a.dict_result.simple_means.symbols && a.dict_result.simple_means.symbols.length > 0 && (I = JSON.stringify({
                simple_means: {
                    symbols: a.dict_result.simple_means.symbols
                }
            })),
            a.dict_result.sim_words && (O.sim_words = a.dict_result.sim_words),
            a.dict_result.net_means && (O.net_means = a.dict_result.net_means)),
            "zh" === t && "en" === s || "en" === t && "zh" === s)
            ...
            W.simpleMeaning = Boolean(O),
            !a.liju_result || "en" !== s && "zh" !== s || !a.liju_result["double"] && !a.liju_result.single || (W.illSen = !0),
            a.trans_result && a.trans_result.keywords && a.trans_result.keywords.length > 0 && ("zh" === t && "en" === s || "en" === t && "zh" === s) && !W.simpleMeaning && (W.keyWord = !0),
            a.simworks && "[object Object]" === Object.prototype.toString.call(a.simworks) && (W.translator = !0)
        }();
        var B = []
            , F = !1;
        !function () {
            ...
            W.festivalLink || W.adLink) {
                var a = [];
                W.festivalLink && a.push("festivalLink"),
                W.adLink && a.push("adLink"),
                    "simpleMeaning" !== B[0] ? (B.unshift.apply(B, a),
                    W.adLink && W.festivalLink && (F = !0)) : B.splice.apply(B, [1, 0].concat(a))
            }
        ...
        J && i.showAppQr(F),
            ...
            "en" === t && "zh" === s || "zh" === t && "en" === s ? (y.genCollapse(),
                f.genNav()) : f.destroyNav()
    }
...
;define("translation:widget/translate/input/uploader", function (t, e, o) {
    "use strict";
    var i = t("translation:widget/common/third_party/webuploader/webuploader.fis")
    ...
    t.progress = m,
        t.clearDocTrans = function (e) {
            $("#main-outer").removeClass("doc-trans-mode").removeClass("doc-trans-view-mode"),
                $(".doc-trans-file").text(""),
            window.common.docHit && !o.get("isInRtTransState") && 0 === $("#baidu_translate_input").val().length && ($("#upload-btn").show(),
...
;define("translation:widget/translate/docTranslate/docTranslate", function (t, n, e) {
    ...
    function d(t) {
        ...
        if (n) {
            ...
            z.attr("src", "https://view.officeapps.live.com/op/embed.aspx?src=" + T.currTask.url)
    }
    ...
    function u(t) {
        t.stopPropagation(),
        D.hasClass("generating") || (T.currTask.isHtml && T.currTask.isOriginalOverflow && !localStorage.getItem("doNotTipExportOverflow") ? (window._hmt.push(["_trackEvent", "首页", "77_首页页面_导出提示展示"]),
            L.show()) : k())
    }
    ...
    var T = t("translation:widget/translate/docTranslate/docTransUtil")
        ...
        , y = (t("translation:widget/common/third_party/md5"),
        $(".doc-trans-view-wrap"))
    ...
    $.fn.scrollEnd = function (t) {
        ...
        $(this).scroll(function (e) {
            var r = $(this);
            return r.is(P) && Z ? void (Z = !1) : (r.data("scrollTimeout") && clearTimeout(r.data("scrollTimeout")),
                void r.data("scrollTimeout", setTimeout(function () {
                    t(e),
                    ...
                    if (n.is(":hover")) {
                        ...
                        do {
                            ...
                            s.is(".not-translated-para") && (c = !1),
                                r = u,
                                a = l.attr(c ? "data-span-idx" : "data-para-idx"))
        ...
        P.scrollEnd(function () {
            ...
            if ($("#main-outer").hasClass("doc-trans-view-mode") && T.currTask.isOverflow) {
                ...
                do {
                    ...
                    u = f - W,
                        d = u >= B * Y,
                    T.currTask.translatingParaIdxSet.has(c.attr("data-para-idx")) || d || (h > 0 ? e = c : u > -(B * X) && t(c, !1))
                    ...
                    $.ajax({
                        ...
                        success: function (t) {
                            if ($("#main-outer").hasClass("doc-trans-view-mode")) {
                                ...
                                for (var e = a.length - n.length, i = 0; e > i; i++)
                                    n.push(null);
            ...
            $(window).on("resize.adjustDocHeight", function () {
                $("#main-outer").hasClass("doc-trans-view-mode") && y.hasClass("viewing-html") && (l(),
                    h())
            }),
            $(p)
    }(),
...
;define("translation:widget/translate/docTransLang/docTransLang", function (t) {
    ...
    function o(t) {
        ...
        d.toggleClass("auto", e),
            e ? d.find(".from-doc-lang").text("中英互译") : (d.find(".from-doc-lang").text(window.common.langList[n]),
                d.find(".to-doc-lang").text(window.common.langList[r])),
            s.removeClass("open"),
            f.from = n,
            f.to = r
    }
    ...
    var l = {
        ...
        setLangOften: function (e) {
            var t, n = {
                value: "",
                text: ""
            }, l = e.langOften, g = e.langOftenList, f = e.getLanguageOftenFunc, o = a.getCookie(l);
            o ? (/%/.test(o) && (o = unescape(o)),
                t = JSON.parse(o)) : t = [];
            ...
            for (i.each(function () {
                ...
                if (e.hasClass("lang-selected")) {
                    ...
                    for (var a = 0; a < t.length; a++)
                        n.value === t[a].value && t.splice(a, 1);
                    return t.push(n),
                        !1
                }
            }); t.length > 3;)
    ...
    var e = a("translation:widget/common/third_party/template")
        ...
        toBtnClicked: function () {
            "none" === $(".to-language-list").css("display") && this.reRenderToList(),
                $(".to-language-list").toggle(0, function () {
        ...
        reRenderToList: function () {
            ...
            $(".to-language-list .data-lang").each(function () {
                var a, t = $(this), g = t.attr("value"), o = n.get("ocrLangList"), r = {
                    value: g,
                    text: t.text(),
                    isSelected: g === s ? !0 : !1,
                ...
                if (l && l.length > 0 && $.inArray(g, l) < 0) {
                    if (t.hasClass("new-lang-disable"))
                        return;
        ...
        hideToWrap: function () {
            "block" === $(".to-language-list").css("display") && ($(".to-language-list").hide(),
                $(".select-to-language .arrow-down").removeClass("lang-arrow-up"))
        },
...
;define("translation:widget/translate/input/processlang", function (t, n, e) {
    ...
    function a(t, n, e) {
        return g.set("detectLang", t),
            g.get("fromLangIsAuto") ? (n = t,
                e = $(".select-to-language .language-selected").attr("data-lang")) : t !== e || g.get("langChangedByUser") || ("zh" === e && $.inArray(n, o) >= 0 ? (s.execExchange(!0),
                e = n,
                n = t,
                $(".trans-prompt").hide()) : "zh" === n && $.inArray(e, o) >= 0 && (s.execExchange(!0),
                e = n,
                n = t,
                $(".trans-prompt").hide())),
    ...
    function r(t, n, e) {
        return l.includes(n) && l.includes(e) && t === e ? (s.execExchange(!0),
            e = n,
            n = t,
            $(".trans-prompt").hide()) : c.includes(n) && "en" === e || !g.get("langList").hasOwnProperty(t) || i.renderPrompt(t, !0),
            {
                fromLang: n,
                toLang: e
            }
    ...
    var g = (t("translation:widget/translate/input/textarea"),
...
;define("translation:widget/translate/input/events", function (t, n) {
    ...
    function o(t) {
        t.stopPropagation(),
        (!S.pasteCompatibility || S.handle(t)) && (d.onRtTrans(t, "paste"),
            y.switchFontSize())
    }
    ...
    function i(t) {
        ...
        if (C.hideWrap(),
            ...
            n) {
            if (13 === t.which)
                return k.getCloseSugByEnter() && k.setCloseSugByEnter(!1),
                    void (k.getTranslatedByKeyDown() ? k.setTranslatedByKeyDown(!1) : g.onTranslate({
                        transtype: "enter"
                    }));
            s.hasQuery(n),
            x.get("shouldClearPromptOnInput") && (p.hide(),
                x.set("shouldClearPromptOnInput", !1))
        } else
            v.translateStopRepeat() || v.shutdownAudio(),
                m.clearAll(!1)
    }
    ...
    n.onClearBtnClick = function () {
        return $("#main-outer").hasClass("doc-trans-mode") ? (window._hmt.push(["_trackEvent", "首页", "文档翻译_上传后点x删除文档"]),
            void (location.href = "/")) : (v.translateStopRepeat() || v.shutdownAudio(),
            m.clearAll(),
            y.switchFontSize(),
            k.clearAndHideSug(),
            void E.updateManualTransBtn())
    }
        ,
        n.init = function () {
            function n(t) {
            ...
            f.on("input", a).on("keyup", a).on("paste", o).on("keydown", r),
                ...
                l.getElem().on("mouseover", function () {
                ...
                l.getElem().on("mouseout", function () {
                    d.timer && clearTimeout(d.timer)
                }),
            ...
            g.on("click", function () {
                ...
                $(window).on("hashchange", function (n) {
                    ...
                    if ("/docTransMode" === e)
                        B.currTask.file ? ($(".doc-trans-file").text(B.currTask.file.name),
                            B.clearDocTransViewMode(),
                            $("#main-outer").addClass("doc-trans-mode"),
                        localStorage.getItem("docTransLangGuideFlag") || ($(".doc-trans-operation").addClass("guiding"),
                            $(".doc-trans-operation .doc-trans-dir").addClass("open"))) : B.clearDocTrans();
            ...
            k || ($("#upload-btn").addClass("with-first-tip"),
...
;define("translation:widget/translate/input/dataTransfer", function (t, e, n) {
    ...
    function c() {
        var t = !1;
        return F ? t = !0 : Date.now() - U < I ? t = !0 : U = Date.now(),
    ...
    var h = function () {
        ...
        , w = t("translation:widget/translate/translang/fromlang")
    ...
    !function () {
        if ("1" === window.common.ocrHit) {
            ...
            t && "function" == typeof t.createObjectURL && !b.msie && !b.ucbrowser && window.FormData && "undefined" != typeof window.FileReader && ("draggable" in document.createElement("span") && (T = !0),
            b.check({
                firefox: "41",
                chrome: "13",
                opera: "12.1"
    ...
    window.common.docHit ? C ? (S.text("输入文字、网址 / 粘贴图片 / 拖入文档"),
        _hmt.push(["_trackEvent", "首页", "54_首页页面_输入框默认文案_输入文字、网址 / 粘贴图片 / 拖入文档"])) : T ? (S.text("输入文字、网址 / 拖入图片、文档"),
        _hmt.push(["_trackEvent", "首页", "54_首页页面_输入框默认文案_输入文字、网址 / 拖入图片、文档"])) : (S.text("输入文字、网址"),
        _hmt.push(["_trackEvent", "首页", "54_首页页面_输入框默认文案_输入文字、网址"])) : C ? (S.text("输入文字、网址或粘贴图片 即可翻译"),
        _hmt.push(["_trackEvent", "首页", "54_首页页面_输入框默认文案_输入文字、网址或粘贴图片 即可翻译"])) : T ? (S.text("输入文字、网址或拖拽图片 即可翻译"),
...
;define("translation:widget/translate/translang/fromlang", function (a, e) {
    ...
    var t = a("translation:widget/common/environment")
        ...
        hideFromWrap: function () {
            "block" === $(".from-language-list").css("display") && ($(".from-language-list").hide(),
                $(".select-from-language .arrow-down").removeClass("lang-arrow-up"))
        },
...
;define("translation:widget/translate/input/correct", function (t, r) {
    ...
    var e, n = t("translation:widget/common/environment"), c = t("translation:widget/common/util"),
        o = (t("translation:widget/translate/input/prompt"),
...
;define("translation:widget/translate/setting/setting", function (e) {
    ...
    var t = e("translation:widget/common/environment")
        ...
        initSetting: function () {
            ...
            r ? "0" === r ? ($(".history-switch").removeClass("setting-checked"),
                t.set("isInHistoryMode", !1)) : "1" === r && t.set("isInHistoryMode", !0) : (s.setCookie("HISTORY_SWITCH", 1, {
                expires: 864e8
            }),
                t.set("isInHistoryMode", !0));
            var d = s.getCookie("SOUND_SPD_SWITCH");
            d ? "0" === d ? ($("#spd-slow").addClass("sound-spd-radio-checked"),
                t.set("soundSpdMode", "slow")) : "2" === d ? ($("#spd-fast").addClass("sound-spd-radio-checked"),
            ...
            a ? "0" === a ? ($("#prefer-uk").addClass("sound-prefer-radio-checked"),
            ...
            c || (c = "hover",
            n.supportLocalStorage && localStorage.setItem("soundTrigger", c)),
...
;define("translation:widget/footer/follow/follow", function (o, t) {
    ...
    function i() {
        $("#follow-btns").on("click", e),
            $("#fdialog-wrap").on("click", a),
